# -*- encoding: utf-8 -*-
# stub: rubocop-github 0.13.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<rubocop>.freeze, ["~> 0.70"])
    s.add_runtime_dependency(%q<rubocop-performance>.freeze, ["~> 1.3.0"])
    s.add_development_dependency(%q<actionview>.freeze, ["~> 5.0"])
    s.add_development_dependency(%q<minitest>.freeze, ["~> 5.10"])
    s.add_development_dependency(%q<rake>.freeze, ["~> 12.0"])
  else
    s.add_dependency(%q<rubocop>.freeze, ["~> 0.70"])
